...
public class TestTransactionManagement {
    ...
    public static void main(String[] args) {
        try {
            ...
            String withdrawSQL = "UPDATE account SET AVAIL_BALANCE = AVAIL_BALANCE - ? WHERE ACCOUNT_ID = ?";
            ...
            String depositSQL = "UPDATE account SET AVAIL_BALANCE = AVAIL_BALANCE + ? WHERE ACCOUNT_ID = ?";
